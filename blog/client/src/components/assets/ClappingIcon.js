...
const ClappingIcon = ({ clap, dataTestId, addClappingAmount }) => (
  <svg onClick={debounce(() => addClappingAmount(dataTestId), 500)}
    viewBox='0 0 24 24'
    width='24'
    height='24'
    aria-label='clap'
    className={clap === true ? 'clappingIconBlue' : 'clappingIconGray'}
